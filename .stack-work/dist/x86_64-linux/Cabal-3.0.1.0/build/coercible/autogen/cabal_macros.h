...
/* package coercible-0.1.0.0 */
#ifndef VERSION_coercible
#define VERSION_coercible "0.1.0.0"
#endif /* VERSION_coercible */
#ifndef MIN_VERSION_coercible
#define MIN_VERSION_coercible(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_coercible */
...
#define CURRENT_COMPONENT_ID "coercible-0.1.0.0-2AkEjDAdXPWJDR7c7ce2P6-coercible"
